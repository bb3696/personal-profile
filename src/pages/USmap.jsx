        ...
        <div className="usmap-map-wrapper">
            ...
            <Geographies geography={geoUrl}>
                ...
                geographies
                    ...
                    const isValidCentroid = Array.isArray(centroid) && centroid.length === 2 && !centroid.includes(undefined);
                    const screenCoord = isValidCentroid ? projection(centroid) : null;
                    ...
                    <Geography
                        ...
                        style={{
                            default: { outline: "none", cursor: "pointer", opacity: isHighlighted ? 1 : 0.4 },
                            hover: { outline: "none", cursor: "pointer" },
                            pressed: { outline: "none" },
                        }}
                    />
                    {screenCoord && (
                        <Annotation subject={centroid} dx={0} dy={0} connectorProps={{ stroke: "none" }}>
                        <text className="statename" x={0} y={0} textAnchor="middle" fontSize={10}>
